  ...
  return (
    <Layout profile={profile} currentPage="store">
      <div style={{ padding: '40px 24px', textAlign: 'center' }}>
        ...
        <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 900, fontStyle: 'italic', fontSize: 32, color: '#F4F7FA', textTransform: 'uppercase', marginBottom: 12 }}>Store</div>
