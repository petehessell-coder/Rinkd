  ...
  return (
    <Layout profile={profile} currentPage="rinkside">
      <div style={{ padding: '40px 24px', textAlign: 'center' }}>
        ...
        <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 900, fontStyle: 'italic', fontSize: 32, color: '#F4F7FA', textTransform: 'uppercase', marginBottom: 12 }}>Rinkside</div>
        <div style={{ color: '#8BA3BE', fontSize: 15, marginBottom: 32 }}>Daily hockey news, highlights and creator content. Coming soon.</div>
